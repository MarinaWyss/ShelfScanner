    ...
    <div className="bg-white min-h-screen">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {isLoading ? (
            ...
            {[...Array(3)].map((_, i) => (
              <Card key={i} className="overflow-hidden bg-white border border-gray-200 shadow-sm">
                <div className="p-4 flex">
                  <Skeleton className="w-24 h-36 rounded-md bg-gray-100" />
          ...
          <div className="text-center py-16 bg-gray-50 rounded-lg p-8 shadow-sm border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {savedBooks.map((book) => (
              <Card key={book.id} className="overflow-hidden bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="p-5 flex">
                  {book.coverUrl ? (
                    ...
                    <div className="w-24 h-36 bg-gray-100 flex items-center justify-center rounded-md shadow-sm">
                      <svg 
                  ...
                  <div className="ml-5 flex-1">
                    <h3 className="font-medium text-gray-900 line-clamp-2 text-lg">{book.title}</h3>
                    ...
                    <div className="mt-3">
                      ...
                      <div className="mt-2 flex items-center">
                        <span className="text-xs text-gray-500">
                          <span className="text-gray-600 mr-1">Date added:</span> 
        ...
        {!isLoading && (
          <div className="mt-10 bg-violet-50 rounded-xl p-8 shadow-sm border border-violet-100 text-center">
            <h3 className="text-xl font-bold text-gray-800 mb-3">Access Your Reading List Everywhere</h3>
