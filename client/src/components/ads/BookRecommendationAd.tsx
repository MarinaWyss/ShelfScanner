...
interface BookRecommendationAdProps {
  className?: string;
}

export default function BookRecommendationAd({ className = '' }: BookRecommendationAdProps) {
  ...
  return (
    <div 
      ref={adContainerRef}
      className={`bg-white border border-neutral-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow ${className}`}
    >
